...
class BimanualIKSolver:
    ...
    Example:
        ...
        ...     left_base_pose=([x_left, y_left, z_left], [qw_left, qx_left, qy_left, qz_left]),
        ...     right_base_pose=([x_right, y_right, z_right], [qw_right, qx_right, qy_right, qz_right]),
        ... )
        >>> 
    ...
    def __init__(
        ...
        Args:
            ...
            left_base_pose: Tuple of (position, quaternion) for the active task's left arm base
                           - position: [x, y, z] in meters
                           - quaternion: [w, x, y, z]
            right_base_pose: Tuple of (position, quaternion) for the active task's right arm base
                            - position: [x, y, z] in meters
                            - quaternion: [w, x, y, z]
        ...
        Example:
            >>> left_pose = ([x_left, y_left, z_left], [qw_left, qx_left, qy_left, qz_left])
            >>> right_pose = ([x_right, y_right, z_right], [qw_right, qx_right, qy_right, qz_right])
...
def solve_bimanual_ik_simple(
    ...
    **kwargs
    ...
    Args:
        ...
        arm: "left" or "right"
        left_base_pose: (position, quaternion) for the active task's left arm.
            Override the default legacy fallback values for the task you are running.
        right_base_pose: (position, quaternion) for the active task's right arm.
            Override the default legacy fallback values for the task you are running.
